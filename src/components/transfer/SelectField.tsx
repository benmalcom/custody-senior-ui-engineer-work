...
import { ChevronDown, ErrorIcon, LoadingIcon } from '@/components/icons'
import { cn } from '@/lib/utils'
import { type FilterTab, SelectDropdown, type SelectOption } from './SelectDropdown'
      ...
      <div className="flex-1 w-full flex justify-between items-center">
        <div>
          {isLoading ? (
            ...
            <div className="text-blue-1 text-[16px] font-medium leading-[19.2px]">{value}</div>
          )}
        </div>
